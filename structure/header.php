        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-evenly" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item m-1">
                        <a class="nav-link" href="structure/article_creation.php">Ajouter un article</a>
                    </li>
                    <li class="nav-item m-1">
                        <a class="nav-link" href="structure/article_display_all.php">Articles</a>
                    </li>
                    <li class="nav-item m-1">
                        <a class="nav-link" href="structure/connection.php">Connexion</a>
                    </li>
                    <li class="nav-item m-1">
                        <a class="nav-link" href="structure/inscription.php">Inscription</a>
                    </li>
                </ul>
            </div>
